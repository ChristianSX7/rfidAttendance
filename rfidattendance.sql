...
CREATE TABLE `users` (
  ...
  `numberplate` varchar(10) NOT NULL DEFAULT 'None',
...
INSERT INTO `users` (`id`, `username`, `serialnumber`, `numberplate`, `email`, `card_uid`, `card_select`, `user_date`, `device_uid`, `device_dep`, `add_card`) VALUES
(2, 'Nguyen Van A', 1, '123', 'vdlaptrinh@gmail.com', '911277', 0, '2021-06-21', '8ceb36c810343326', 'DTVT 20A', 1),
